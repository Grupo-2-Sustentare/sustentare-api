package com.example.sustentaree.configuration.security;

import com.example.sustentaree.configuration.security.jwt.GerenciadorTokenJwt;
import com.example.sustentaree.controllers.autenticacao.AutenticacaoService;
...
public class SecurityConfiguracao {
  ...
  private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
      ...
      new AntPathRequestMatcher("/usuarios/**"),
          new AntPathRequestMatcher("/usuarios/usuario-ultimo-id"),
      new AntPathRequestMatcher("/usuarios/*"),
      new AntPathRequestMatcher("/usuarios"),
      new AntPathRequestMatcher("/usuarios/login/**"),
          new AntPathRequestMatcher("/usuarios/gravarTxt/**"),
      ...
      new AntPathRequestMatcher("/produtos/**"),
          new AntPathRequestMatcher("/audit-logs"),
          new AntPathRequestMatcher("/audit-logs/**"),
          new AntPathRequestMatcher("/lambda/**"),
          new AntPathRequestMatcher("/lambdaTest/baixarImagem"),
          new AntPathRequestMatcher("/lambdaTest/**"),
  ...
  public AutenticacaoFilter jwtAuthenticationFilterBean(){
    return new AutenticacaoFilter(autenticacaoService, jwtAuthentificationUtilBean());
  }

  @Bean
  public GerenciadorTokenJwt jwtAuthentificationUtilBean(){
